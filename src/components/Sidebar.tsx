...
export default function Sidebar({togglemode, isDarkMode}: {togglemode: () => void, isDarkMode?:boolean}) {
    return (
        <div className="bg-theme_black-light dark:bg-theme_black-dark text-black dark:text-white h-20 md:h-screen flex justify-between items-center md:flex-col md:justify-start md:rounded-2xl p-4 text-center">
